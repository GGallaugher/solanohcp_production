...
GeoExt.Lang.add("el", {
    ...
    "gxp.FilterBuilder.prototype": {
        builderTypeNames: ["\u03bf\u03c0\u03bf\u03b9\u03bf\u03b4\u03ae\u03c0\u03bf\u03c4\u03b5", "\u03cc\u03bb\u03b1", "\u03ba\u03b1\u03bd\u03ad\u03bd\u03b1",
            "\u03cc\u03c7\u03b9 \u03cc\u03bb\u03b1"
        ],
...
GeoExt.Lang.add("hr", {
    ...
    "gxp.FilterBuilder.prototype": {
        builderTypeNames: ["jednom",
            "svima", "niti jednom", "ne svima"
        ],
...
GeoExt.Lang.add("nl", {
    ...
    "gxp.FilterBuilder.prototype": {
        builderTypeNames: ["om het even welk",
            "alle", "geen", "niet alle"
        ],
...
gxp.CatalogueSearchPanel = Ext.extend(Ext.Panel, {
                ...
                columns: [{
                    ...
                    items: [{
                        ...
                        handler: function(a, b) {
                            ...
                            g && (c = g.apply({
                                id: c
                            }), window.open(c, "MDWindow", "width=800, height=600, scrollbars=1, resizable=1"))
                        },
                        scope: this
                    }]
                }, {
    ...
    findWMS: function(a) {
        ...
        for (e = 0, f = a.length; e < f; ++e)
            if (g = a[e], g.protocol && -1 !==
                b.indexOf(g.protocol.toUpperCase()) && g.value && g.name) {
                c = g.value;
                d = g.name;
                break
            }
...
gxp.plugins.AddLayers = Ext.extend(gxp.plugins.Tool, {
    ...
    addLayers: function(a, b) {
        ...
        e && h && this.zoomToLayer && this.target.mapPanel.map.zoomToExtent(e);
                        ...
                        var a = new gxp.LayerUploadPanel(Ext.apply({
                                ...
                                listeners: {
                                    uploadcomplete: function(a, c) {
                                        for (var d = c["import"].tasks, e, f = {}, g = 0, q = d.length; g <
                                            q; ++g) {
                                            e = d[g];
                                            if ("ERROR" === e.state) {
                                        ...
                                        this.selectedSource.store.load({
                                            ...
                                            callback: function() {
                                                ...
                                                var c = [],
                                                    d = 0;
                                                this.selectedSource.store.each(function(a,
                                                    b) {
...
gxp.plugins.LayerProperties = Ext.extend(gxp.plugins.Tool, {
    ...
    addActions: function() {
        var a, b = gxp.plugins.LayerProperties.superclass.addActions.apply(this, [{
                menuText: this.menuText,
        ...
        this.target.on("layerselectionchange", function(b) {
            a = b;
            c.setDisabled(!b || !b.get("properties"))
        }, this);
        var d = function(b) {
            c.setDisabled(!a || !a.get("source") || 1 >= b.getCount())
        };
        this.target.mapPanel.layers.on({
            add: d,
            remove: function(b) {
    ...
    addOutput: function(a) {
        ...
        this.outputConfig.title = (this.initialConfig.outputConfig || {}).title || this.menuText +
            ": " + b.get("title");
...
gxp.plugins.OpacitySlider = Ext.extend(gxp.plugins.Tool, {
    ...
    addActions: function() {
        var a, b = gxp.plugins.OpacitySlider.superclass.addActions.apply(this, [{
                menuText: this.menuText,
...
gxp.plugins.OverviewMap = Ext.extend(gxp.plugins.Tool, {
    ...
    init: function(a) {
        ...
        a.on("ready", this.addOverviewMap, this)
    },
    addOverviewMap: function() {
        var a = this.target.mapPanel.map;
        if (!(0 >= a.layers.length && this.layerName || this.added)) {
            var b;
            if (this.layerName)
                if ((b = a.getLayersByName(this.layerName)) &&
                    0 < b.length) b = b[0].clone(), delete b.params.ISBASELAYER, b = b instanceof OpenLayers.Layer.OSM ? new OpenLayers.Layer.OSM : new OpenLayers.Layer.WMS("OverviewMap", b.url, {
                    layers: b.params.LAYERS
                }, b.options);
                else throw Error("The layer of the OverviewMap cannot be found in the Map");
            else if (this.layer) {
                var c = this.target.layerSources[this.layer.source];
                c && (record = c.createLayerRecord(this.layer), b = record.getLayer())
            }
            c = this.initialConfig.size || [200, 220];
            if (this.mapOptions && this.mapOptions.maxExtent) this.mapOptions.maxExtent =
                OpenLayers.Bounds.fromArray(this.mapOptions.maxExtent);
            b = {
                size: new OpenLayers.Size(c[0], c[1]),
                layers: [b]
            };
            b.mapOptions = this.mapOptions;
            if (this.initialConfig.outputTarget) c = Ext.get(this.initialConfig.outputTarget), b.div = c.dom;
            a.addControl(new OpenLayers.Control.OverviewMap(b));
            this.added = !0
        }
    }
});
...
gxp.plugins.RemoveLayer = Ext.extend(gxp.plugins.Tool, {
    ...
    addActions: function() {
        ...
        this.target.on("layerselectionchange", function(b) {
            a = b;
            c.setDisabled(1 >= this.target.mapPanel.layers.getCount() ||
                !b || !b.get("source"))
        }, this);
        var d = function(b) {
            c.setDisabled(!a || !a.get("source") || 1 >= b.getCount())
