...
# the resulting point.
$sql =  "
    SELECT * FROM public.parcels WHERE
    ST_Contains(
        parcels.geom, 
        ST_Transform(
            ST_SetSRID(
...
?>				
				...
				<b>Habitat Plan Measures related to project design and construction that may apply:</b><br>
				<br>
...
<p>&nbsp;</p>
				...
				<a class ="button" href= "<?= $row['reportlink']?>"target="_blank" align='right'>View and Print these Measures</a><br><br>	<br>
...
<br><Br><b><a href="http://solanohcp.com/documents/HCP_Compliance_Checklist.pdf" target="_blank" align ='center'>Link to all HCP Measures</a></b> 
