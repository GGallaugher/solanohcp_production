...
<b>Habitat Plan Measures related to project design and construction that may apply<br> (Further information or Survey Needed)</b><br>	
...
<td style="width: 45px; height: 17px;">&nbsp;<?= $row['vpg_des_45']?></td>
						...
						<p style="font-size:8px"><p class="tab">&#9679;&nbsp;&nbsp;<i>Additional design and construction measures that may apply:<BR></i><?=$row['may_apply']?></p>
