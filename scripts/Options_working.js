...
//srsName: "EPSG:900913",
	    ...
	    {type: "printdirect", options: {url:"http://lsagis.net/devsolanohcp/scripts/pdf", mapTitle: 'My Title - Direct Print'
        , mapTitleYAML: "mapTitle"	,	// MapFhttp://lsagis.net/ish - field name in config.yaml - default is: 'mapTitle'
		srs:"EPSG:900913"
   ...
   {type: "printdialog", options: {url: 'http://lsagis.net/devsolanohcp/scripts/pdf', windowWidth: 360, 
   showTitle: true
 // , mapTitle: 'My Header - Print Dialog'
  ...
  //   , mapCommentYAML: "mapComment"	// MapFish - field name in config.yaml - default is: 'mapComment'
      , showFooter: true
     , mapFooter: 'Solano HCP Geobrowser'
    , mapFooterYAML: "mapFooter"	    // MapFish - field name in config.yaml - default is: 'mapFooter'
, printAttribution: true        // Flag for printing the attribution
		 , mapAttribution: null           // Attribution text or null = visible layer attributions
 	 , mapAttributionYAML: "mapAttribution" // MapFish - field name in config.yaml - default is: 'mapAttribution'
