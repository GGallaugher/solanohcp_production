...
Heron.globals = {
serviceUrl: "/cgi-bin/heron.cgi?url=",
    version: '1.0.6',
    imagePath: undefined
};
...
try {
    ...
    Proj4js.defs["EPSG:900913"] = "+proj=sterea +lat_0=52.15616055555555 +lon_0=5.38763888888889 +k=0.999908 +x_0=155000 +y_0=463000 +ellps=bessel +units=m +towgs84=565.2369,50.0087,465.658,-0.406857330322398,0.350732676542563,-1.8703473836068,4.0812 +no_defs";
    // Somehow Proj4JS tries to load this def, without success...
    Proj4js.defs["EPSG:4326"] = "+proj=utm +zone=31 +ellps=GRS80 +units=m +no_defs";
} catch (err) {
    // ignore
}
